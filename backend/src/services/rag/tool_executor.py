...
class ParallelToolExecutor:
    ...
    async def execute_plan(
        ...
        while pending:
            ...
            tasks = {
                ex.tool_name: self._execute_with_retry(ex, context)
                for ex in ready
            }
    ...
    def analyze_dependencies(
        ...
        for call in tool_calls:
            ...
            if tool_name == "load_documents_full":
                if not args.get("document_ids") and "search_user_documents" in tool_names:
